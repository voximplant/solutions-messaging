import { ConversationsState, Participant, Conversation, User } from '@/types/src/conversations';
...
const getters: GetterTree<ConversationsState, any> = {
  ...
  currentConversation: (state) => {
    return state.conversations.find((c: Conversation) => c.uuid === state.currentConversationId);
  },
  // @ts-ignore
