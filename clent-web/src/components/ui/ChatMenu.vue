<template lang="pug">
  v-container(class="pa-0")
    ...
    CreateChat(:dialog.sync="popupNewChat" :type="conversationType")
...
import CreateChat from '@/components/ui/CreateChat.vue';
...
export default class ChatMenu extends Vue {
  ...
  public items = [
    { title: 'New Chat', icon: 'add_circle', function: () => this.showPopupNewChat() },
    { title: 'New Channel', icon: 'add_circle_outline', function: () => this.showPopupNewChannel() },
    { title: 'About', icon: 'account_circle', function: () => this.showPopupAboutUser() },
  ];
  ...
  showPopupNewChat() {
    ...
    this.popupNewChat = !this.popupNewChat;
  }
