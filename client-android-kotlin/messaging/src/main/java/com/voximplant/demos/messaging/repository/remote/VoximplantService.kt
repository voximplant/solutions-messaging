...
class VoximplantService(private val messenger: IMessenger) : IMessengerListener {
    ...
    init { this.messenger.addMessengerListener(this) }
    ...
    fun requestUsersWithUsernames(usernames: List<String>, completion: (Result<List<IUser>>) -> Unit) {
        messenger.getUsersByName(usernames, object : IMessengerCompletionHandler<List<IUserEvent>> {
            override fun onSuccess(events: List<IUserEvent>) {
                completion(success(events.map { it.user }))
            }
    ...
    fun createConversation(config: ConversationConfig, completion: (Result<IConversationEvent>) -> Unit) {
        messenger.createConversation(config, object : IMessengerCompletionHandler<IConversationEvent> {
    ...
    fun requestMultipleConversations(uuids: List<String>, completion: (Result<List<IConversation>>) -> Unit) {
        messenger.getConversations(uuids, object: IMessengerCompletionHandler<List<IConversationEvent>> {
    ...
    fun requestSingleConversation(uuid: String, completion: (Result<IConversation>) -> Unit) {
        messenger.getConversation(uuid, object: IMessengerCompletionHandler<IConversationEvent> {
            override fun onSuccess(conversationEvent: IConversationEvent) {
    ...
    fun recreateConversation(uuid: String, config: ConversationConfig, lastSequence: Long?): IConversation? =
        messenger.recreateConversation(config, uuid, lastSequence ?: 0, 0, 0)


    fun addParticipants(participants: List<ConversationParticipant>, conversation: IConversation, completion: (Result<IConversationEvent>) -> Unit) {
        conversation.addParticipants(participants, object : IMessengerCompletionHandler<IConversationEvent>{
            override fun onSuccess(conversationEvent: IConversationEvent) {
                completion(success(conversationEvent))
            }
            override fun onError(errorEvent: IErrorEvent) {
    ...
    fun editParticipants(participants: List<ConversationParticipant>, conversation: IConversation, completion: (Result<IConversationEvent>) -> Unit) {
        conversation.editParticipants(participants, object : IMessengerCompletionHandler<IConversationEvent> {
            override fun onSuccess(conversationEvent: IConversationEvent) {
                completion(success(conversationEvent))
            }
            override fun onError(errorEvent: IErrorEvent) {
    ...
    fun removeParticipants(participants: List<ConversationParticipant>, conversation: IConversation, completion: (Result<IConversationEvent>) -> Unit) {
        conversation.removeParticipants(participants, object : IMessengerCompletionHandler<IConversationEvent>{
            override fun onSuccess(conversationEvent: IConversationEvent) {
                completion(success(conversationEvent))
            }
            override fun onError(errorEvent: IErrorEvent) {
    ...
    fun updateConversation(conversation: IConversation, completion: (Result<IConversationEvent>) -> Unit) {
    ...
    fun requestMessengerEvents(conversation: IConversation, numberOfEvents: Int, sequence: Long, completion: (Result<List<IMessengerEvent>>) -> Unit) {
        conversation.retransmitEventsTo(sequence, numberOfEvents, object: IMessengerCompletionHandler<IRetransmitEvent> {
    ...
    fun sendMessage(text: String, conversation: IConversation, completion: (Result<IMessageEvent>) -> Unit) {
        conversation.sendMessage(text, null, object : IMessengerCompletionHandler<IMessageEvent> {
